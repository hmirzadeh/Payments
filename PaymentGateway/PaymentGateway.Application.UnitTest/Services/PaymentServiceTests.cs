...
namespace PaymentGateway.Application.UnitTests.Services
{
    public class PaymentServiceTests
    {
        ...
        [Test]
        public void Given_ProcessPayment_Triggered_When_Payment_Is_Valid_Then_PaymentResult_Should_Be_Successful_And_PaymentId_IsNot_Null()
        {
        ...
        [Test]
        public void Given_ProcessPayment_Triggered_When_SendRequest_Throws_Exception_Then_PaymentResult_Should_Be_InternalError()
        {
            _mockHttpProcessor.Setup(x => x.SendRequest<Payment, PaymentResult>(
        ...
        [Test]
        public void Given_RetreivePayment_Triggered_When_PaymentId_Is_Valid_Then_It_Should_Return_A_Payment_And_Mask_CardNumber()
        {
